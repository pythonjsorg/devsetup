...
import { homeHref } from '@/lib/devtools-paths'
...
const NAV_ITEMS: {
  ...
  { label: 'Install',  detail: 'Tool recipes',       href: homeHref, icon: 'bolt',   soon: false },
...
export default function MobileNav() {
  ...
  useEffect(() => { setMounted(true); setPathname(window.location.pathname) }, [])
